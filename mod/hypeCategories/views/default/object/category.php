...
//}
                ...
                if (get_input('context') !== 'site' &&
                    ...
                    if (get_context() !== 'groups') {
                        if (get_plugin_setting('allow_groups', 'hypeCategories') == 'yes') {
                            $context = get_context();
                            set_context('search');
                ...
                foreach ($types as $type) {
                    ...
                    if (in_array($type, string_to_tag_array(get_plugin_setting('allowed_object_types', 'hypeCategories')))) {
                        ...
                        if (!empty($objects)) {
                            foreach ($objects as $object) {
                                if (get_input('context') == 'site' or $object->container_guid == page_owner() or $object->getSubtype() == get_input('context')) {
                                    echo elgg_view_entity($object);
                                }
                            }
                        }
